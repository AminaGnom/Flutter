          ...
          child: Column(
            children: [
              Container(
                ...
                child: Image.asset("images/group122.png", fit: BoxFit.fill),
              ),
              Container(
              ...
              Container(
                ...
                child: ElevatedButton.icon(
                    icon: const ImageIcon(
                      AssetImage("images/group21.png"), //тут
                      color: Colors.white,
                      size: 50,
                    ),
                      ...
                      Column(
                        ...
                        children: [
                          Container(
                            ...
                            child:
                                Image.asset("images/group22.png", fit: BoxFit.fill),
                          ),
                        ],
                      )
                    ],
